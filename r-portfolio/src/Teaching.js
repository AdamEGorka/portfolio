  ...
  return (
    <div className="teaching-grid">
      <div className="teaching-item">
        ...
        <p className="mini-title" style={{ color: '#333' }}>January 2024 - Now</p>
        <p style={{ color: '#333' }}>
          ...
          I'm particularly excited to serve as a teaching assistant for this course, I
      ...
      <div className="teaching-item">
        ...
        <p className="mini-title" style={{ color: '#333' }}>August 2023 - December 2023</p>
        <p style={{ color: '#333' }}>
